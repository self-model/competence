...
```{r}
folder_path <- "../AllBatchesData/batch_1"
```
...
set path of main folder
```{r}
folder_path_2 <- "../AllBatchesData/batch_2"
```
...
set path of main folder
```{r}
folder_path_3 <- "../AllBatchesData/batch_3"
```
...
set path of main folder
```{r}
folder_path_4 <- "../AllBatchesData/batch_4"
```
...
set path of main folder
```{r}
folder_path_5 <- "../AllBatchesData/batch_5"
```
