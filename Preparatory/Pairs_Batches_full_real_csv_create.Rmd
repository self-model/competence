...
```{r}
folder_path <- "../All_batches_data/batch_1"
```
...
set path of main folder
```{r}
folder_path_2 <- "../All_batches_data/batch_2"
```
...
set path of main folder
```{r}
folder_path_3 <- "../All_batches_data/batch_3"
```
...
set path of main folder
```{r}
folder_path_4 <- "../All_batches_data/batch_4"
```
...
set path of main folder
```{r}
folder_path_5 <- "../All_batches_data/batch_5"
```
