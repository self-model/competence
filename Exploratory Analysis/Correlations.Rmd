...
Correlation analyses for: 

1. Correlation for accuracy - participant/individual level
2. Correlation between self-rating and confidence 
3. Correlation between mean misses per word and mean ranking per word
4. Correlation between mean word difficulty per participant and mean predicted position ranking 
5. Correlation between mean misses per participant and mean predicted position ranking 

*Note - For correlation between word completion speed and predicted position please see speed analysis folder
...
1. CORRELATION FOR ACCURACY - PARTICIPANT/INDVIDUAL LEVEL 
...
combined_cor_plot
ggsave(file="Exploratory Plots/combinedCorrelationWordScatter.png")
```


4. CORRELATION BETWEEN MEAN WORD DIFFICULTY PER PARTICIPANT AND MEAN PREDICTED POSITION RANKING BY PARTICIPANT
...
5. CORRELATION BETWEEN MEAN MISSES PER PARTICIPANT AND MEAN PREDICTED POSITION RANKING BY PARTICIPANT
