...
jsPsych.plugins['type-this'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var responses = [];
    var html = `<div id="jspsych-survey-text-preamble" class="jspsych-survey-text-preamble"><p>The next hidden word is ${trial.word.toUpperCase()}.</p>
      ...
      <input type="submit" id="jspsych-survey-text-next" class="jspsych-btn jspsych-survey-text" value="continue"></input>
      </form>`
